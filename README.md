...
1. **Gender Pay Gap Over Time (1981-2013)**  
...
![Gender Pay Gap Over Time]([gender_pay_gap_over_time.png](https://github.com/JMiceli7/gender-gap-analysis/blob/main/Images/pay_gap_over_time.png))

2. **Average Wage by Age Bracket and Gender**  
...
3. **Average Wage by Occupation (Top Occupations for Women)**  
...
4. **Average Wage by Occupation (Top Occupations for Men)**  
